      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _index.sendClientError)(_context.t0);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./index":"index.js"}],"logout.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./index":"index.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxpeWV2MTIiLCJhIjoiY2s0MWJoOWlmMDBjeTNtbXgwYmp6amhsYiJ9.1mK0-aIBWT0ykPPbiDDbbw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/aliyev12/ck41buypo0sm81cphwedlbdoz',
...
var stripe = Stripe('pk_test_JSq8JfVQ4vrmvquqWGeqbUnN00LPioBOVN');
...
if (domainEl) exports.domain = domain = domainEl.dataset.domain;
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', onSubmitUserPassword);
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  (0, _stripe.bookTour)(tourId); // e.target.textContent = 'Book Tour';
});
...
function onSubmitUserPassword(_x) {
  return _onSubmitUserPassword.apply(this, arguments);
}

function _onSubmitUserPassword() {
  _onSubmitUserPassword = _asyncToGenerator(
  /*#__PURE__*/
...
function sendClientError() {
  return _sendClientError.apply(this, arguments);
}

function _sendClientError() {
  _sendClientError = _asyncToGenerator(
  /*#__PURE__*/
