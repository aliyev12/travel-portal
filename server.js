...
/* Every 24h heroku sends a SIGTERM signal to server
which force servers to restart. This signal is generated by dyno (container)
and is designed to have all servers run smoothly. But this can cause some issues
within app, so this should be handled in the following way: */
process.on('SIGTERM', () => {
  console.log('SIGTERM signal received, shutting down gracefully.');
  // Shutdown the server, but do finish processing all requests
  server.close(() => {
